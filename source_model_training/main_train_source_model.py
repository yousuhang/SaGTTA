...
def segmentation_model_params(parser):
    ## Experiment Specific
    parser.add_argument('--checkpoints_dir', default='/home/syou/sagtta_experiments/logs_spinal_cord_site1/bilinear_1em6_torch_t', type=str)
    ...
    ## Datasets
    parser.add_argument('--dataroot', default='/home/syou/SpinalCord_depth_train_npy',
