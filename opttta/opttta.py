...
from utils.utils import ensure_dir, clip_gradient, overlay_segs, getcolorsegs, natural_sort
...
class OptTTA():
    ...
    def initialize(self):
        ...
        self.target_test_dataloader = GenericVolumeDataset(self.opt.dataroot, self.opt.target_sites,
                                                           phase='test')
